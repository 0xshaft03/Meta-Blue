...
.NOTES  
    ...
    This is the original Meta-Blue that uses Create-Artifact and has the remote collection built in as well.
    It probably doesn't have all of the same datapoints that Invoke-Collection has.
#>
